...
const Home: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[100svh] shrink-0 grow-0 tall:h-[calc(100svh_-_80px)]">
        <div
        ...
        <div className="absolute inset-y-0 flex items-center justify-center">
          <div className="mx-4 flex flex-col items-center justify-center gap-4 overflow-auto rounded-sm bg-black bg-opacity-50 p-4 text-zinc-900 lg:mx-16">
